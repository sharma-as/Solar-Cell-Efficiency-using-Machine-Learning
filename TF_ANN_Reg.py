...
#Random weight initialization with fixed seed number
...
model.add(layers.Dense(30, input_dim=2, kernel_regularizer=regularizers.l2(0.05), kernel_initializer=test_initializer, activation='relu'))
model.add(layers.Dense(10, kernel_regularizer=regularizers.l2(0.05), kernel_initializer=test_initializer, activation='relu'))
